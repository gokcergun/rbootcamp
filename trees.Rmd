...
Add the coordinates of San Francisco and create a map

```{r}
sf <- c(lon = -122.3999, lat = 37.7846)
map <- GetMap(center=sf, zoom=13)
...
```{r}
sanf_map <- ggmap(map) + geom_point(aes(longitude, latitude), data = df_trees) 
```
