...
ui <- fluidPage(
    ...
    sidebarLayout(
        ...
        selectInput(inputId = "species_nor",
                    label = "Choose a species:",
                    choices = c(' Japanese Blueberry Tree', ' Flaxleaf Paperbark', 
                                ' Red Flowering Gum', ' Flowering Cherry', ' Little Gem Magnolia'), 
...
shinyApp(
  ...
  server = function(input, output) {
    ...
    if (input$species_nor == "All Species") {
      df_trees_filtered
    } else {
      filter(df_trees_filtered, species == input$species_nor)
    }
  })
