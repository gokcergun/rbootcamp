...
plot map using leaflet, to create a hover over dot pop up with species name, given not enough colors to differentiate so many speices
```{r}
#map center
mlong = -122.4446
mlat  = 37.75695
...
leaflet(data = df_trees_rare, 
        ...
        addCircleMarkers(lng = df_trees_rare$longitude, 
                         ...
                         radius = 4,
                         color = factor(df_trees_rare$species_lat))
```
