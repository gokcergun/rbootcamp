...
The below code show that the number of unique species after recategorize the species is 158.
```{r}
...
Select the top 5 species with a planted data. 'Trees' category will be omitted
...
```{r}
selected_species = c('Prunus', 'Tristaniopsis', 'Lophostemon', 'Magnolia', 'Arbutus')
