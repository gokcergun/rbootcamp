...
```{r}
san_francisco = c(left=-122.7, bottom = 37.5, right = -122.3, top = 37.9)
smap <- get_stamenmap(san_francisco, maptype = "watercolor") %>%
  ggmap()
```

```{r fig.height=12, fig.width=12}
smap + geom_point(data = df_trees_filtered, aes(x=longitude, y = latitude, col = species_nor))
