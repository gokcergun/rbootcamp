...
map of Species per  (https://sfenvironment.org/sites/default/files/fliers/files/sf_tree_guide.pdf) : 
...
species <- df_trees_filtered$species_nor %>% unique()
#pal <- leaflet::colorFactor(viridis_pal(option = "C")(2), domain = species)
...
leaflet(data = df_trees_filtered, 
        ...
        addCircleMarkers(lng = df_trees_filtered$longitude, 
                         ...
                         color = df_trees_filtered$species_nor,
                         group = df_trees_filtered$species_nor,
...
plot map using leaflet, to create a hover over dot pop up with species name, give not enough colors to differentiate so many speices
```{r}
#map center
mlong = -122.4446
mlat  = 37.75695
...
leaflet(data = df_trees_rare, 
        ...
        addCircleMarkers(lng = df_trees_rare$longitude, 
                         ...
                         popup = df_trees_filtered$species_lat,
                         label = df_trees_filtered$species_lat, 
                         radius = 4)
```
